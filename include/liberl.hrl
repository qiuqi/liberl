...
-define(HTTP_OK(Req, Opts), j:jsonOk(Req,Opts)).
-define(HTTP_OK_TIME(Req, Time, Opts), j:jsonOkTime(Req, Time, Opts)).
-define(HTTP_FAILED(Req, Opts), j:jsonFailed(Req, Opts)).
